...
public class TrackListAdapter extends ArrayAdapter<Track>{
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ImageView ivAlbumImage = (ImageView) customRow.findViewById(R.id.ivRowAlbumImage);

        tvTrackName.setText(listItem.getSongName());
        tvArtist.setText(listItem.getArtist());

        String imgLink = listItem.getImageLink();

        new ImageAsyncTask(ivAlbumImage).execute(imgLink);
